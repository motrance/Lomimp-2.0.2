...
/*
 * Lomimp
 * connector.ConnectLotto
 * 
 * @version 2.0.2
 * @since 2026-05-15
*/
public class ConnectLotto  extends ConnectorCore implements IConnector {
    public ConnectLotto(LogProvider log, SettingsSet settingsSet) {
        super(log);
                    ...
                    if (currentLine == null) {
                        ...
                        if (currentLine.contains("<div class=\"date\">")) {
                            ...
                            try {
                                ...
                                //FIX so replaceAll is not needed
                                ...
                                while(currentLine != null && !currentLine.contains("</ul>")) {
                                    if (!row.getDate().isEmpty() && currentLine.trim().contains("<li class=\"ball  medium ball\">")) {
                                        currentLine = currentLine.replaceAll("\t", "");
                                        currentLine = currentLine.replace("<li class=\"ball  medium ball\">", "");
