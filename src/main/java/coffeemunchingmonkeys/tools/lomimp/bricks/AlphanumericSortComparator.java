 ...
 *
 * Lomimp
 * bricks.AlphanumericSortComparator
 * 
 * @version 2.0.2
 * @since 2026-05-15
 **/
public final class AlphanumericSortComparator<T> implements  Comparator<T> {
    //Fields
    public static final Comparator<String> NUMERICAL_ORDER = new AlphanumericSortComparator<>(false);
    public static final Comparator<String> CASE_INSENSITIVE_NUMERICAL_ORDER = new AlphanumericSortComparator<>(true);
